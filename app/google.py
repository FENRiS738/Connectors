...
google_routes = APIRouter(prefix='/google/auth')
...
@google_routes.get("/login")
async def login():
    """Redirect user to Google login."""
    return {"url": oauth_client.generate_auth_url()}

@google_routes.get("/callback")
